 ...
 * @version 1.0.0
 */
abstract class AbstractDao<Key, Model> implements ExecuteDbCallback<Key, Model> {
	...
	AbstractDao(SQLiteDatabase db, String tableName, Column[] allColumns, Column[] pkColumns) {
		this.mDb = db;
