...
public class XComplexModel implements Serializable{
    ...
    private List<StringModel> simpleModelList;

    private List<XMediumModel> mediumModelList;

    public XComplexModel(String userName, int id, long time, List<String> strList, List<StringModel> simpleModelList, List<XMediumModel> mediumModelList) {
    ...
    public List<StringModel> getSimpleModelList() {
        return simpleModelList;
    }

    public void setSimpleModelList(List<StringModel> simpleModelList) {
        this.simpleModelList = simpleModelList;
    }
